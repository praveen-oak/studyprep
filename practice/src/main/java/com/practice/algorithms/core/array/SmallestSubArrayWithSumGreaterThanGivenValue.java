...
public class SmallestSubArrayWithSumGreaterThanGivenValue implements IAlgorithm
{

    private static Logger log = Logger.getLogger(SmallestSubArrayWithSumGreaterThanGivenValue.class);
    ...
    public String run(JSONObject input) {
        ...
        try {
            ...
            log.error("SmallestSubArrayWithSumGreaterThanGivenValue.run  -  Exception in running algorithm", e);
        }
    ...
    public void setInput(JSONObject input) {
        ...
        try {
            ...
            log.error("SmallestSubArrayWithSumGreaterThanGivenValue.setInput  -  Exception in setting input", e);
        }
        ...
        while (end < inputData.size()) {
            ...
            if (currSum > sum) {
                ...
                if (end - start < minLength) {
                    ...
                    log.info("Start: " + inputData.get(start-1) + ", End: " + inputData.get(end-1));
